    ...
    <TableLoader :isLoading="isLoading">
        ...
        <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            ...
            <div class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4">
                <div>
                    <h5 class="mr-3 font-semibold dark:text-white">User Management</h5>
                ...
                <div class="flex space-x-3">
                    ...
                    <button type="button"
                        class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-primary-800">
            ...
            <!-- <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 md:rounded-lg">
                <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                    ...
                    <button type="button"
                            class="px-4 py-2 text-sm font-medium text-gray-900 bg-primary border border-gray-200 rounded-t-lg md:rounded-tr-none md:rounded-l-lg hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-2 focus:ring-primary-700 focus:text-primary-700 dark:bg-primary dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-primary-500 dark:focus:text-white">
                        All
                    </button>
                    <button type="button"
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <th scope="row" class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img class="w-8 h-8 rounded-full mr-2" :src="`https://i.pravatar.cc/150?u=fake${user.id}@pravatar.com`" alt="Rounded avatar">
                            ...
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="flex items-center">
                                    <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">Active</span>
                                </div>
                            </td>
                            <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                Administrator
            ...
            <nav class="flex flex-col items-start justify-between p-4 space-y-3 md:flex-row md:items-center md:space-y-0" aria-label="Table navigation">
                ...
                <Paginator :links="users.links" @pageChanged="queries.page = $event.page"></Paginator>
            </nav>
...
import TableLoader from '../../components/ui/loaders/TableLoader.vue';
...
const fetchUser = async () => {
    try {
        ...
        const response = await UserService.get(queries.value)
